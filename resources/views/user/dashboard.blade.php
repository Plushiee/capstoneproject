                            ...
                            <div class="box">
                                <div class="box-body d-flex pb-0">
                                    <div class="me-auto">
                                        ...
                                        <p class="fs-14 mb-0 mt-11"><span class="text-primary">+0.5% </span>than last
                                            month</p>
                                    </div>
                            ...
                            <div class="box box-manage">
                                <div class="box-body d-flex pd-7 pb-0">
                                    <div class="me-auto w-55">
                                        <h5 class="card-title text-white fs-30 font-w500 mt-4">Manage your project in one
                                            touch</h5>
                                        <p class="mb-0 text-o7 fs-18 font-w500 pb-11">Etiam facilisis ligula nec velit
                                            posuere egestas. Nunc dictum</p>
                                    </div>
                                    <div class="btn-now">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div class="me-auto">
                                        ...
                                        <p class="fs-18 mb-0 mt-6"><span class="text-primary pr-7">+3.2</span>than last
                                            week</p>
                                    </div>
                                </div>
                                <div class="box-body">
                        ...
                        <div class="col-6 col-xl-12 col-md-12 col-sm-12">
                            <div class="box">
                                <div class="box-body center">
                                    <div class="w-100"><span class="donut-2 w-100"
                                            data-peity='{ "fill": ["#9B8DFF", "#E4EAF8"]}'>228,134</span>
                                    </div>
                                    <h5 class="fs-20 mb-0 mt-20 font-w500 color-text mt-28">On Progress<span
                                            class="text-primary font-w600 pl-8">50% </span></h5>
                                ...
                                <div class="owl-carousel owl-theme">
                                    <div class="box box-carousel">
                                        ...
                                        <div class="card-center">
                                            ...
                                            <div class="progress skill-progress mb-23" style="height:7px; width: 80%;">
                                                <div class="progress-bar bg-primary progress-animated"
                                                    style="width: 52%; height:7px;" role="progressbar">
                                                </div>
                                            </div>
                                    ...
                                    <div class="box box-carousel">
                                        ...
                                        <div class="card-center">
                                            ...
                                            <div class="progress skill-progress mb-23" style="height:7px; width: 80%;">
                                                <div class="progress-bar bg-primary progress-animated"
                                                    style="width: 67%; height:7px;" role="progressbar">
                                                </div>
                                            </div>
                                            <div class="sm-f-wrap d-flex justify-content-between">
                                                <ul class="user-list">
                                    ...
                                    <div class="box box-carousel">
                                        ...
                                        <div class="card-center">
                                            ...
                                            <div class="progress skill-progress mb-23" style="height:7px; width: 80%;">
                                                <div class="progress-bar bg-primary progress-animated"
                                                    style="width: 68%; height:7px;" role="progressbar">
                                                </div>
                                            </div>
                                            <div class="sm-f-wrap d-flex justify-content-between">
                                                <ul class="user-list">
                                ...
                                <div class="col-6 col-xl-12 w-sm-100 mb-0">
                                    ...
                                    <div class="canvas-container">
                                        ...
                                        <div class="chart-data">
                                            ...
                                            <div data-percent="12.5" data-color="#EF7F5A" data-label="Brand Identity">
                                            </div>
                                ...
                                <li class="dlab-chat-user">
                                    <div class="d-flex bd-highlight">
                                        <div class="img_cont border-blue">
                                            <img src="./images/avatar/message-04.png" class="rounded-circle user_img"
                                                alt="" />
                                        </div>
                                        <div class="user_info">
