                ...
                <div class="card mb-4">
                    <div class="card-header d-flex flex-row align-items-center justify-content-between">
                        <div class="col d-flex justify-content-between">
                            ...
                            <button id="addCerita" class="btn btn-fw primary" type="submit" style="color:#fff">Tambah
                                Cerita</button>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="">
                            ...
                            <div id="konten-cerita">
                                @for ($i = 1; $i <= $jml_cerita; $i++)
                                    <div id="cerita{{ $i }}">
                                        <div class="row align-items-center mt-3">
                                            <div class="col-auto">
                                                <a
                                                    style="color: #2c3e50;margin-bottom:0px;font-size: 20px;font-weight: 600;display: flex;">#{{ $i }}</a>
                                            </div>
                                            <div class="col">
                                                <a id="{{ $i }}" class="btn btn-sm btn_remove"
